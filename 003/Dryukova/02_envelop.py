...
if (paper_x<=envelop_x and paper_y<=envelop_y):
    ...
    if (paper_y<=envelop_x and paper_x<=envelop_y):
        print('yes')
    else:
        print ('no')
...
if (brick_x<=hole_x and brick_y<=hole_y):
    ...
    if (brick_y<=hole_x and brick_x<=hole_y):
        print('yes')
    else:
        if (brick_z<=hole_x and brick_y<=hole_y):
            print('yes')
        else:
            if (brick_y <= hole_x and brick_z <= hole_y):
                print('yes')
            else:
                if (brick_z <= hole_x and brick_x <= hole_y):
                    print('yes')
                else:
